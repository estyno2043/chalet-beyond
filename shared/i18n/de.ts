...
export const de: Dict = {
  ...
  pricing: {
    ...
    youSave: "Sie sparen",
    childPrice: "Kinder 0–15 Jahre: 40 € pro Nacht. Ab 16 Jahren gilt der Tarif aus der Tabelle.",
    finePrint:
  ...
  booking: {
    ...
    adults: "Erwachsene",
    adultsHint: "ab 16 Jahren",
    children: "Kinder",
    childrenHint: "0–15 Jahre · 40 € pro Nacht",
    childrenDecrease: "Weniger Kinder",
    childrenIncrease: "Mehr Kinder",
  ...
  rules: {
    ...
    quiet: "Ruhezeit",
    children: "Kinder",
    childrenValue: "Willkommen · 0–15 J. 40 € pro Nacht, ab 16 J. als Erwachsene",
    cribs: "Kinderbetten",
