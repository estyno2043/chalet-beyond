...
export const sk = {
  ...
  pricing: {
    ...
    youSave: "ušetríte",
    childPrice: "Deti 0–15 rokov: 40 € za noc. Od 16 rokov platí cena podľa tabuľky.",
    finePrint:
  ...
  booking: {
    ...
    adults: "Dospelí",
    adultsHint: "od 16 rokov",
    children: "Deti",
    childrenHint: "0–15 rokov · 40 € za noc",
    childrenDecrease: "Menej detí",
    childrenIncrease: "Viac detí",
  ...
  rules: {
    ...
    quiet: "Ticho",
    children: "Deti",
    childrenValue: "Vítané · 0–15 r. 40 € za noc, od 16 r. ako dospelí",
    cribs: "Postieľky",
