...
export const pl: Dict = {
  ...
  pricing: {
    ...
    youSave: "oszczędzasz",
    childPrice: "Dzieci 0–15 lat: 40 € za noc. Od 16 lat obowiązuje cena z tabeli.",
    finePrint:
  ...
  booking: {
    ...
    adults: "Dorośli",
    adultsHint: "od 16 lat",
    children: "Dzieci",
    childrenHint: "0–15 lat · 40 € za noc",
    childrenDecrease: "Mniej dzieci",
    childrenIncrease: "Więcej dzieci",
  ...
  rules: {
    ...
    quiet: "Cisza nocna",
    children: "Dzieci",
    childrenValue: "Mile widziane · 0–15 lat 40 € za noc, od 16 lat jak dorośli",
    cribs: "Łóżeczka",
