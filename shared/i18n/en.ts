...
export const en: Dict = {
  ...
  pricing: {
    ...
    youSave: "you save",
    childPrice: "Children aged 0–15: €40 per night. From 16 the table rate applies.",
    finePrint:
  ...
  booking: {
    ...
    adults: "Adults",
    adultsHint: "16 and over",
    children: "Children",
    childrenHint: "0–15 years · €40 per night",
    childrenDecrease: "Fewer children",
    childrenIncrease: "More children",
    callUs: "Call us on",
    orWrite: "or write to",
    finePrint:
  ...
  rules: {
    ...
    quiet: "Quiet hours",
    children: "Children",
    childrenValue: "Welcome · ages 0–15 €40 per night, 16+ charged as adults",
    cribs: "Cots",
