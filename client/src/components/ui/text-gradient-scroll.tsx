"use client";
// TextGradientScroll — scroll-driven letter/word reveal
// Adapted for Chalet Beyond: amber accent color on revealed text, dark ghost text
// Source: pasted_content_4 (user-provided component)
